...
public class Main {
    public static void main(String[] args) {
        ...
        Optional<String> optional = Optional.ofNullable(names);
        optional.map((line) -> Arrays.stream(line.split("\n")).toList())
                .ifPresentOrElse(System.out::println, () -> System.out.println("Empty file"));
    }
}
